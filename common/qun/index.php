...
$qun_hmid = addslashes(str_replace("_", "\_", $_GET["hmid"]));
	...
	if ($result_hminfo->num_rows > 0) {
			    ...
			    // 没有符合条件的群二维码
	       		...
	       		if ($qun_wx_status == '1') {
	       			...
	       			echo '<br/><br/><br/>
	       			      ...
	       			      <div id="tips_text">暂无群可以加入<br/>如需进群可联系微信：cbzqx66</div>';
		...
		echo '<title>提醒</title>
    	      ...
    	      <br/><br/><br/>
       	      ...
       	      <div id="tips_text">该二维码不存在或已被管理员删除<br/>如需进群可联系微信：cbzqx66</div>';
